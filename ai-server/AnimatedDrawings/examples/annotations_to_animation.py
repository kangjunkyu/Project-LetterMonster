...
def annotations_to_animation(char_anno_dir: str, motion_cfg_fn: str, retarget_cfg_fn: str, character_id: str, motion: str):
    ...
    print("- package character_cfg_fn, motion_cfg_fn, and retarget_cfg_fn")
    ...
    mvc_cfg = {
        ...
        'controller': {
            ...
            'OUTPUT_VIDEO_PATH': str(Path(char_anno_dir, filename).resolve())}  # set the output location
    }

    print("- write the new mvc config file out")
