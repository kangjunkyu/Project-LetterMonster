...
public class QUsers extends EntityPathBase<Users> {
    ...
    public final ListPath<com.lemon.backend.domain.characters.character.entity.Characters, com.lemon.backend.domain.characters.character.entity.QCharacters> characterList = this.<com.lemon.backend.domain.characters.character.entity.Characters, com.lemon.backend.domain.characters.character.entity.QCharacters>createList("characterList", com.lemon.backend.domain.characters.character.entity.Characters.class, com.lemon.backend.domain.characters.character.entity.QCharacters.class, PathInits.DIRECT2);
