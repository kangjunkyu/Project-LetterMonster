...
public class UserServiceTest {
    ...
    public void getUserInfoTest() {
        // given
        Users createdUser = userService.createUser(mockedUserInfo, Social.KAKAO);
        UserGetDto dto = UserGetDto.builder().id(USER_ID).isLanguageSet(false)
                .nickname(NICKNAME).nicknameTag(NICKNAME_TAG).build();
        when(userService.getUserInfo(USER_ID)).thenReturn(dto);
